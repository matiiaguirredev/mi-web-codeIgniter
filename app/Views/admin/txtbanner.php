<div class="row">
    <div class="col">
        <div class="card">
            <div class="card-body">
                <h4 class="header-title">Lista de textos en banner</h4>
                <p class="sub-header">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">Textos en banner</h4>
                                ...
                                <table id="basic-datatable" class="table dt-responsive nowrap w-100 table-bordered">
                                    ...
                                    <tbody>
                                        <?php
                                        // debug($txtbanner, false); 
                                        foreach ($txtbanner as $key => $txt) {
                                            // debug($txtbanner, false);
                                        ?>
                                            <tr>
                                                ...
                                                <td class="text-center d-flex justify-content-center gap-1" colspan="">
                                                    ...
                                                    <div class="form-check form-switch">
                                                        <input class="form-check-input ch-txtbanner-<?= $txt->id; ?>" onchange="changeactivotxt(<?= $txt->id; ?>)" type="checkbox" role="switch" id="flexSwitchCheckChecked" <?= ($txt->activo) ? 'checked' : ''; ?>>
                                                    </div>
                                                </td>
                                            </tr>
                                        <?php
