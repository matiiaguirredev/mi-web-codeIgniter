...
<div class="px-3">
    ...
    <div class="container-fluid">
        ...
        <div class="py-3 py-lg-4">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="page-title mb-0">Lista de Comentarios de blog</h4>
                </div>
                <div class="col-lg-6">
                    <div class="d-none d-lg-block">
                        <ol class="breadcrumb m-0 float-end">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Comentarios de blog</a></li>
                            <li class="breadcrumb-item active">Comentarios de blog</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-12">
                                <div class="p-2">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-2 row">
                                            <label class="form-label col-md-2 col-form-label">Comentario en blog: </label> <br />
                                            <div class="col-md-10">
                                                <select name="titulo_blog" id="selectize-select">
                                                    ...
                                                    <?php foreach ($blog as $key => $b) { ?>
                                                        <option value="<?= $b->titulo ?>"><?= $b->titulo ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-md-10">
                                                <textarea class="form-control" name="comentario" id="example-textarea" rows="5"></textarea>
                                            </div>
                                        </div>
