<div class="px-3">
    ...
    <div class="container-fluid">
        ...
        <div class="py-3 py-lg-4">
            <div class="row">
                <div class="col-lg-6">
                    <h4 class="page-title mb-0">Estudios y Experiencias</h4>
                </div>
                <div class="col-lg-6">
                    <div class="d-none d-lg-block">
                        <ol class="breadcrumb m-0 float-end">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Curriculum</a></li>
                            <li class="breadcrumb-item active">Estudios y Experiencias</li>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="col-12">
                                <div class="p-2">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-2 row">
                                            <label class="col-md-2 col-form-label" for="simpleinput">Sub titulo </label>
                                            <div class="col-md-10">
                                        ...
                                        <div class="mb-2 row">
                                            <label class="col-md-2 col-form-label" for="simpleinput">Año laboral: </label>
                                            <div class="col-md-10">
                                                <input type="number" name="rango_anos" id="simpleinput" class="form-control" min="2000" max="2100">
                                            </div>
                                        </div>
                                        ...
                                        <!-- <div class="mb-2 row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="date" name="desde" id="simpleinput" class="form-control" min="2000" max="2100">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="date" name="hasta" id="simpleinput" class="form-control" min="2000" max="2100">
                                            </div>
                                        </div> -->
