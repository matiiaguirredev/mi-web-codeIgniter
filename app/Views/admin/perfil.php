                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <div style="display:inline;width:165px;height:165px;">
                        ...
                        <form role="form" class=" row" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="col-6 mb-2 ">
                                <div class="mb-2">
                                    ...
                                    <input type="text" name="nombre" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $user->informacion->nombre ;?>">
                                </div>
                            </div>
                            <div class="col-6 mb-2 ">
                                <div class="mb-2">
                                    <label for="exampleInputEmail1" class="form-label">Last Name</label>
                                    <input type="text" name="apellido" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $user->informacion->apellido ;?>">
                                </div>
                            </div>
                            <div class="col-6 mb-2 ">
                                <label for="exampleInputEmail1" class="form-label">Edad</label>
                                <input type="number" name="edad" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" value="<?= $user->informacion->edad ;?>">
                            </div>
