                                ...
                                <div class="p-2">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="iconHTML" id="simpleinput" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="info" id="simpleinput" class="form-control">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="info_secundaria" id="simpleinput" class="form-control" placeholder="Opcional">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group mb-0 text-center">
                                            <button class="btn btn-primary w-100" type="submit">Cargar metodo de contacto</button>
                                        </div>
