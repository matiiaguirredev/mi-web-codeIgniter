                                ...
                                <div class="p-2">
                                    ...
                                    <form action="" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="usuario" id="usuario" class="form-control" value="<?= $usuarios->usuario ?>">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-md-10">
                                                <select name="role_id" id="selectize-select">
                                                    ...
                                                    <?php foreach ($roles as $key => $rol) { ?>
                                                        <option value="<?= $rol->id ?>" <?= ($rol->id == $usuarios->role_id) ? 'selected' : ''; ?>><?= $rol->nombre ?></option>
                                                    <?php }; ?>
                                                </select>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" name="apellido" id="apellido" class="form-control" value="<?= $usuarios->apellido ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-2 row">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-check form-switch">
                                                    <input class="form-check-input" name="activo" type="checkbox" role="switch" id="flexSwitchCheckChecked" <?= ($usuarios->activo) ? 'checked' : ''; ?> </div>
                                                </div>
                                            </div>
